            ...
            <div className="mb-6">
              ...
              <div className="flex space-x-2">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <Star
                      className={`h-8 w-8 transition duration-150 ${star <= rating ? 'text-yellow-400 fill-current drop-shadow-md' : 'text-gray-300'
                        }`}
                    />
                  </button>
                ))}
              ...
              <div key={review._id} className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <img
                      src={review.profilePhoto && review.profilePhoto.length > 0 ? review.profilePhoto : '/default-avatar.png'}
